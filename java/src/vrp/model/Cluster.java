...
public class Cluster {
    ...
    public void add(Node n) {
        ...
        amount += n.amount;
        if(nodes.size()>1){
            this.totalDist+=MyUtils.calculateDistance(nodes.get(nodes.size()-2), n);
        }
    }
